...
{
  "original_hash": "f9a2e382d4d784730b50698abfd6c97d",
  "translation_date": "2025-05-13T03:57:37+00:00",
  "source_file": "plotsquared/configuration/settings.md",
  "language_code": "tw"
}
-->
# 一般設定
...
這是 PlotSquared 的主要設定檔。

*位置在：* `/plugins/PlotSquared/config/settings.yml`
...
**免責聲明**：  
本文件係使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們致力於翻譯準確，但請注意，自動翻譯可能包含錯誤或不準確之處。原始文件之母語版本應視為權威資料來源。對於重要資訊，建議採用專業人工翻譯。我們不對因使用本翻譯所產生之任何誤解或誤譯負責。